...
const BusinessProfileModal = ({ setOpen }) => {
  return (
    <div
      className="relative z-10 p-9"
        ...
        <div className="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
          <div className="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 w-[52rem]">
            ...
            <i class="fa-solid fa-square-xmark" style={{
                ...
                <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6 ">
                  <div class="mx-auto max-w-screen-sm text-center mb-8 lg:mb-16">
                    ...
                    <p class="font-light text-gray-500 lg:mb-16 sm:text-xl dark:text-gray-400">
                      Abhishek Chauhan, the proud owner of our AC repair
                      business, brings a wealth of expertise and a passion for
                      delivering exceptional service to every project
                    </p>
                  </div>
              ...
              {/* Team Section */}
              <div className="mb-4">
                <div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-0 lg:py-14 mx-auto">
                  ...
                  <div class="max-w-2xl mx-auto">
                    <div class="hs-accordion-group">
                      ...
                      >
                        ...
                        >
                          <p class="text-gray-800 dark:text-gray-200">
                            ...
                            while you cancel but we would highly appreciate if
                      ...
                      >
                        ...
                        >
                          <p class="text-gray-800 dark:text-gray-200">
                            Our subscriptions are tiered. Understanding the task
                      ...
                      >
                        ...
                        >
                          <p class="text-gray-800 dark:text-gray-200">
                            ...
                            don't panic! We've got you covered. You can login to
                            your account, tap your avatar in the upper right
                            corner, and tap Purchases. If you didn't create a
                            login or can't remember the information, you can use
                            our handy Redownload page, just remember to use the
                      ...
                      >
                        ...
                        >
                          <p class="text-gray-800 dark:text-gray-200">
                            There may be times when you need to upgrade your
                            license from the original type you purchased and we
                            have a solution that ensures you can apply your
